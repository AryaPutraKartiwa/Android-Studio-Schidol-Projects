...
public class AddPlanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageButton reqplan = (ImageButton) view.findViewById(R.id.requestplan);
        reqplan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction fr = getFragmentManager().beginTransaction();
                fr.replace(R.id.frame_layout,new CalendarFragment());
                fr.commit();
            }
        });
        return view;
